	...
	<div className="panel">
		<form onSubmit={handleSubmit(signup)}>
			<div>
				...
				<Field name="email" label="Endereço de email" component={RenderInput} />
				<Field name="firstname" label="Primeiro nome" component={RenderInput} />
				<Field name="lastname" label="Último nome" component={RenderInput} />
